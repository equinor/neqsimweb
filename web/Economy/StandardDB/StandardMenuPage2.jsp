            ...
            <ui:html id="html1">
                ...
                <ui:body id="body1" style="-rave-layout: grid">
                    <ui:form id="form1">
                        ...
                        <h:outputText id="topMenuText1" style="left: 240px; top: 24px; position: absolute; width: 672px" styleClass="title1" title="title1" value="Process Economy Standard Database"/>
                        ...
                        <ui:dropDown binding="#{Economy$StandardDB$StandardMenuPage2.standardTypeDropDown}" id="standardTypeDropDown"
                            items="#{Economy$StandardDB$StandardMenuPage2.standardTypeDropDownDefaultOptions.options}"
                            onChange="common_timeoutSubmitForm(this.form, 'standardTypeDropDown');"
                            style="height: 24px; left: 384px; top: 144px; position: absolute; width: 240px" valueChangeListener="#{Economy$StandardDB$StandardMenuPage2.standardTypeDropDown_processValueChange}"/>
                        <ui:hyperlink action="#{Economy$StandardDB$StandardMenuPage2.hyperlink1_action}" id="hyperlink1"
                            style="height: 24px; left: 672px; top: 144px; position: absolute; width: 144px" text="Add new standard"/>
                        <ui:dropDown binding="#{Economy$StandardDB$StandardMenuPage2.standardSubjectDropDown}" id="standardSubjectDropDown"
                            items="#{Economy$StandardDB$StandardMenuPage2.standardSubjectDropDownDefaultOptions.options}"
                            onChange="common_timeoutSubmitForm(this.form, 'standardSubjectDropDown');"
                            style="height: 24px; left: 384px; top: 192px; position: absolute; width: 240px" valueChangeListener="#{Economy$StandardDB$StandardMenuPage2.standardSubjectDropDown_processValueChange}"/>
                        <ui:table augmentTitle="false" id="table1" style="height: 260px; left: 240px; top: 240px; position: absolute" title="Table" width="438">
                            <ui:tableRowGroup binding="#{Economy$StandardDB$StandardMenuPage2.tableRowGroup1}" id="tableRowGroup1" rows="10"
                                sourceData="#{Economy$StandardDB$StandardMenuPage2.standardsDataProvider}" sourceVar="currentRow">
                                ...
                                <ui:tableColumn headerText="LINK" id="tableColumn4" sort="documents.LINK">
                                    <ui:hyperlink id="hyperlink3" target="_blank" text="#{currentRow.value['documents.LINK']}" url="#{Economy$StandardDB$StandardMenuPage2.standardsDataProvider.value['documents.LINK']}"/>
                                </ui:tableColumn>
                                <ui:tableColumn headerText="DELETE" id="tableColumn6">
                                    <ui:button action="#{Economy$StandardDB$StandardMenuPage2.button2_action}" id="button2" text="Delete"/>
                                </ui:tableColumn>
                                <ui:tableColumn headerText="OPEN" id="tableColumn7" width="80">
                                    <ui:button action="#{Economy$StandardDB$StandardMenuPage2.button3_action}"
                                        binding="#{Economy$StandardDB$StandardMenuPage2.button3}" id="button3" text="Open"/>
                                </ui:tableColumn>
                            </ui:tableRowGroup>
                        </ui:table>
                        <ui:messageGroup id="messageGroup1" style="position: absolute; left: 840px; top: 144px; width: 192px; height: 192px"/>
                        <div style="position: absolute; left: 24px; top: 216px; width: 72px; height: 48px">
