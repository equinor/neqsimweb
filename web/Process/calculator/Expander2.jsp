                ...
                <ui:body id="body1" style="-rave-layout: grid">
                    <ui:form id="form1">
                        ...
                        <ui:textField binding="#{Process$calculator$Compressor.temperatureTextField}"
                            ...
                            style="height: 24px; left: 456px; top: 96px; position: absolute; width: 168px" text="20.0"/>
                        ...
                        <ui:textField binding="#{Process$calculator$Compressor.pressureTextField}" converter="#{Process$calculator$Compressor.doubleConverter1}"
                            id="pressureTextField" style="height: 24px; left: 456px; top: 144px; position: absolute; width: 168px" text="1.0"/>
                        <ui:staticText id="staticText4" style="height: 24px; left: 624px; top: 144px; position: absolute; width: 96px" text="[bar]"/>
                        <ui:button action="#{Process$calculator$Compressor.calculateButton_action}" id="calculateButton1"
                            style="left: 455px; top: 312px; position: absolute" text="Calcuate"/>
                        <h:dataTable binding="#{Process$calculator$Compressor.resultsTable}" headerClass="list-header" id="resultsTable"
                        ...
                        <ui:textField binding="#{Process$calculator$Compressor.pressureOutTextField}"
                            ...
                            style="height: 24px; left: 456px; top: 192px; position: absolute; width: 168px" text="2.0"/>
                        ...
                        <ui:textField binding="#{Process$calculator$Compressor.isentropicTextField}"
                            ...
                            style="height: 24px; left: 456px; top: 240px; position: absolute; width: 168px" text="0.9"/>
                        ...
                        <ui:dropDown binding="#{Process$calculator$Compressor.efficiencyTypeDropDown}" id="efficiencyTypeDropDown"
                            items="#{Process$calculator$Compressor.efficiencyTypeDropDownDefaultOptions.options}" style="height: 24px; left: 240px; top: 264px; position: absolute; width: 216px"/>
                        ...
                        <ui:panelLayout binding="#{Process$calculator$Compressor.temperatureOutPanel}" id="temperatureOutPanel" panelLayout="flow"
                            rendered="false" style="height: 94px; left: 720px; top: 216px; position: absolute; width: 262px">
                            ...
                            <ui:button action="#{Process$calculator$Compressor.estimateEfficiencyButton_action}" id="estimateEfficiencyButton" text="Estimate"/>
                        </ui:panelLayout>
                        <ui:staticText id="staticText10" style="height: 24px; left: 240px; top: 360px; position: absolute; width: 214px" text="Compressor work"/>
                        <ui:staticText id="staticText11" style="height: 24px; left: 624px; top: 360px; position: absolute; width: 96px" text="[W]"/>
                        <ui:staticText binding="#{Process$calculator$Compressor.workTextField}" converter="#{Process$calculator$Compressor.doubleConverter1}"
                            id="workTextField" style="position: absolute; left: 456px; top: 360px; width: 168px; height: 24px" text="-"/>
                    </ui:form>
                </ui:body>
            </ui:html>
        </ui:page>
