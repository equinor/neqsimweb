 ...
 *
 * @version Expander.java
 * @version Created on 07.jul.2009, 16:20:38
 * @author esol
 */
public class Expander extends AbstractPageBean {
    ...
    public void init() {
        ...
        try {
            ...
            log("Expander Initialization Failure", e);
    ...
    public String calculateButton_action() {
        ...
        expansion.setIsentropicEfficiency((Double) isentropicTextField.getValue());
        tempStream.run();
        expansion.run();
        getThermo$ThermoSessionBean().setThermoSystem(expansion.getOutStream().getThermoSystem());
        ...
        workTextField.setValue((Double) expansion.getTotalWork());
        return null;
    }
