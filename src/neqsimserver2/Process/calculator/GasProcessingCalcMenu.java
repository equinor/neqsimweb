 ...
 *
 * @version GasProcessingCalcMenu.java
 * @version Created on 27.jun.2009, 21:55:24
 * @author ESOL
 */
public class GasProcessingCalcMenu extends AbstractPageBean {
    ...
    public void init() {
        ...
        try {
            _init();
            getSessionBean1().setActiveSubject("GasProcess");
        } catch (Exception e) {
            log("GasProcessingCalcMenu Initialization Failure", e);
