 ...
 * @author esol
 */
public class GasScrubber extends AbstractPageBean {
    ...
    private TextField liquidCarryOver = new TextField();

    public TextField getLiquidCarryOver() {
        return liquidCarryOver;
    }

    public void setLiquidCarryOver(TextField tf) {
        this.liquidCarryOver = tf;
    }
    ...
    public String calculateButton_action() {
        ...
        neqsim.processSimulation.processEquipment.separator.Separator scrubber = new neqsim.processSimulation.processEquipment.separator.Separator("gas scrubber", tempStream);
        scrubber.setLiquidCarryoverFraction((Double) liquidCarryOver.getValue()/100.0);
        scrubber.setPressureDrop((Double) pressureDropTextField.getValue());
        tempStream.run();
        scrubber.run();
        getThermo$ThermoSessionBean().setThermoSystem(scrubber.getGasOutStream().getThermoSystem());
    ...
    public void liquidCarryOver_processValueChange(ValueChangeEvent event) {
    }
