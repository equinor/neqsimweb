 ...
 *
 * @version InterfacialTension2.java
 * @version Created on 31.mai.2013, 23:18:16
 * @author ESOL
 */
public class InterfacialTension2 extends AbstractPageBean {
    ...
    public void init() {
        ...
        try {
            ...
            log("InterfacialTension2 Initialization Failure", e);
    ...
    public void temperatureTextField_processValueChange(ValueChangeEvent vce) {
    }
}
