...
public class MeasurementDB2 extends AbstractPageBean {
    ...
    private void _init() throws Exception {
        litteratureDataProviderTable.setCachedRowSet((javax.sql.rowset.CachedRowSet) getValue("#{SessionBean1.litteratureRowSet}"));
        litteratureDataProvider.setCachedRowSet((javax.sql.rowset.CachedRowSet) getValue("#{SessionBean1.litteratureRowSet2}"));
    }
    ...
    public void init() {
        ...
        try {
            ...
            log("MeasurementDB2 Initialization Failure", e);
...
//       try{
//            getSessionBean1().getLitteratureRowSetDataBase().setObject(1,"VLE");
...
//    }
    public String button1_action() {
        RowKey rowKey = tableRowGroup1.getRowKey();
       // litteratureDataProviderTable.setCursorRow(rowKey);
       // getSessionBean1().setActiveFluidID(Integer.parseInt(litteratureDataProviderTable.getValue("FLUIDID").toString()));
        int fluidid = Integer.parseInt(litteratureDataProvider.getValue("FLUIDID", rowKey).toString());
