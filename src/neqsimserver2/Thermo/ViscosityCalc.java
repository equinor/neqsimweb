 ...
 *
 * @version ViscosityCalc.java
 * @version Created on 02.jun.2013, 07:50:28
 * @author ESOL
 */
public class ViscosityCalc extends AbstractPageBean {
    ...
    public void init() {
        ...
        try {
            ...
            log("ViscosityCalc Initialization Failure", e);
            throw e instanceof FacesException ? (FacesException) e : new FacesException(e);
        }

        getThermo$ThermoSessionBean().setActiveExperimentType("viscosity");
        getThermo$ThermoSessionBean().setActiveWikiCategory("viscosity");
        // </editor-fold>
        // Perform application initialization that must complete
