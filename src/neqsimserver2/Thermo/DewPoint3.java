 ...
 */
public class DewPoint3 extends AbstractPageBean {
    ...
    private void _init() throws Exception {
        calcuationRadioButtonGroupDefaultOptions.setOptions(new com.sun.rave.web.ui.model.Option[]{new com.sun.rave.web.ui.model.Option("dewt", "Dew point temperature"), new com.sun.rave.web.ui.model.Option("dewp", "Dew point pressure")});
        calcuationRadioButtonGroupDefaultOptions.setSelectedValue("dewt");
    }
    ...
    public String okButton_action() {
        try {
            ...
            bubblePointPressureTextField.setValue("could not calculate dew point..");
            bublePointTemperatureTextField.setValue("could not calculate dew point..");
            return null;
        }
    }
}
