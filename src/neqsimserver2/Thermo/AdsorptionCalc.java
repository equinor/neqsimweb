 ...
 *
 * @version AdsorptionCalc.java
 * @version Created on 02.jun.2013, 08:07:41
 * @author ESOL
 */
public class AdsorptionCalc extends AbstractPageBean {
    ...
    private void _init() throws Exception {
        radioButtonGroup1DefaultOptions.setOptions(new com.sun.rave.web.ui.model.Option[]{new com.sun.rave.web.ui.model.Option("AC", "Active carbon"), new com.sun.rave.web.ui.model.Option("SG", "Silica Gel"), new com.sun.rave.web.ui.model.Option("MS3A", "Molecular Sieve 3A"), new com.sun.rave.web.ui.model.Option("MS4A", "Molecular Sieve 4A")});
        radioButtonGroup1DefaultOptions.setSelectedValue("AC");
        doubleRangeValidator1.setMaximum(100000.0);
    }
    ...
    public void init() {
        ...
        try {
            ...
            log("AdsorptionCalc Initialization Failure", e);
            throw e instanceof FacesException ? (FacesException) e : new FacesException(e);
        }

        getThermo$ThermoSessionBean().setActiveExperimentType("adsorption");
        getThermo$ThermoSessionBean().setActiveWikiCategory("adsorption");
        // </editor-fold>
        // Perform application initialization that must complete
