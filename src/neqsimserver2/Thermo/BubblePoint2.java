 ...
 */
public class BubblePoint2 extends AbstractPageBean {
    ...
    private void _init() throws Exception {
        calcuationRadioButtonGroupDefaultOptions.setOptions(new com.sun.rave.web.ui.model.Option[]{new com.sun.rave.web.ui.model.Option("bubt", "Bubble point temperature"), new com.sun.rave.web.ui.model.Option("bubp", "Bubble point pressure")});
        calcuationRadioButtonGroupDefaultOptions.setSelectedValue("bubt");
    }
    ...
    private SingleSelectOptionsList calcuationRadioButtonGroupDefaultOptions = new SingleSelectOptionsList();

    public SingleSelectOptionsList getCalcuationRadioButtonGroupDefaultOptions() {
        return calcuationRadioButtonGroupDefaultOptions;
    }

    public void setCalcuationRadioButtonGroupDefaultOptions(SingleSelectOptionsList ssol) {
        this.calcuationRadioButtonGroupDefaultOptions = ssol;
    }
    private RadioButtonGroup calcuationRadioButtonGroup = new RadioButtonGroup();

    public RadioButtonGroup getCalcuationRadioButtonGroup() {
        return calcuationRadioButtonGroup;
    }

    public void setCalcuationRadioButtonGroup(RadioButtonGroup rbg) {
        this.calcuationRadioButtonGroup = rbg;
    }
    ...
    public String okButton_action() {
        try {
            ...
            try {
                if (calcuationRadioButtonGroup.getValue().toString().equals("bubt")) {//(bubPointTCheckBox.isSelected()) {
            ...
            bubblePointPressureTextField.setValue("could not calculate bublepoint..");
            bublePointTemperatureTextField.setValue("could not calculate bublepoint..");
            return null;
        }
    }
}
