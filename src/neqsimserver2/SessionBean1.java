...
public class SessionBean1 extends AbstractSessionBean {
    ...
    private void _init() throws Exception {
        ...
        analyserlocationviewRowSet.setCommand("SELECT ALL analyserlocations.`STED`,                      analyserlocations.`ID1`  FROM analyserlocations");
        ...
        analysertypeviewRowSet.setCommand("SELECT ALL analysertypes.ID1,                      analysertypes.INSTTYPES  FROM analysertypes ");
        ...
        analysersRowSet.setCommand("SELECT ALL analysers.ID,                      analysers.INSTRUMENTTYPE,                      analysers.STED,                      analysers.FORMAL,                      analysers.INSTRUMENT,                      analysers.ANTALL,                      analysers.PLASSERING,                      analysers.TAGNR,                      analysers.KALIBRERINGSRUTINER,                      analysers.VEDLIKEHOLDSRUTINER,                      analysers.ERFARING,                      analysers.ONLINEOFFLINE,                      analysers.KONTAKTPERSON,                      analysers.KOMMENTARER,                      analysers.INSTALLASJONAAR  FROM analysers WHERE analysers.INSTRUMENTTYPE = ?           AND analysers.STED = ? GROUP BY analysers.ID, analysers.INSTRUMENTTYPE, analysers.STED, analysers.FORMAL, analysers.INSTRUMENT, analysers.ANTALL, analysers.PLASSERING, analysers.TAGNR, analysers.KALIBRERINGSRUTINER, analysers.VEDLIKEHOLDSRUTINER, analysers.ERFARING, analysers.ONLINEOFFLINE, analysers.KONTAKTPERSON, analysers.KOMMENTARER, analysers.INSTALLASJONAAR ");
        ...
        litteratureRowSetGetLitID.setCommand("SELECT ALL litterature.`ID`,                      litterature.`FLUID_ID`,                      litterature.`NAME`,                      litterature.`TEXT`,                      litterature.`EXPTYPEID`,                      litterature.`TYPE`,                      litterature.`ARTICLEID`,                      litterature.`MINTEMPERATURE`,                      litterature.`MAXTEMPERATURE`,                      litterature.`MINPRESSURE`,                      litterature.`MAXPRESSURE`,                      experimentaldatatype.`TYPE`  FROM litterature, experimentaldatatype WHERE litterature.`ID` = ?           AND litterature.`EXPTYPEID` = experimentaldatatype.`ID`");
        ...
        experimentaldatatypeRowSet.setCommand("SELECT ALL experimentaldatatype.`ID`,                      experimentaldatatype.`TYPE`  FROM experimentaldatatype ORDER BY experimentaldatatype.`TYPE` ASC");
        ...
        webcomponentsRowSet.setCommand("SELECT ALL webcomponents.`ID`,                      webcomponents.`NAME`,                      webcomponents.`TABLEROWNAME`  FROM webcomponents");
        ...
        literatureandarticlestableRowSetSetArtID.setCommand("SELECT ALL literatureandarticlestable.`ID`,                      literatureandarticlestable.`AUTHOR`,                      literatureandarticlestable.`NAME`,                      literatureandarticlestable.`JOURNAL`,                      literatureandarticlestable.`VOLUME`,                      literatureandarticlestable.`PAGES`,                      literatureandarticlestable.`YEAR`,                      literatureandarticlestable.`REFERENCEID`  FROM literatureandarticlestable WHERE literatureandarticlestable.`ID` = ?");
        ...
        analysertypesviewRowSet.setCommand("SELECT ALL analysertypesview.`ID1`,                      analysertypesview.`INSTTYPES`  FROM analysertypesview");
        ...
        analysertypesRowSet.setCommand("SELECT ALL analysertypes.`ID1`,                      analysertypes.`INSTTYPES`  FROM analysertypes");
        ...
        litteratureRowSet2.setCommand("SELECT ALL litterature.`ID`,                      litterature.`FLUID_ID`,                      litterature.`FILE`,                      litterature.`TYPE`,                      litterature.`NAME`,                      litterature.`TEXT`,                      litterature.`EXPTYPEID`,                      experimentaldatatype.`ID` AS `EXPID`,                      experimentaldatatype.`TYPE` AS `EXPTYPE`,                      userdb.`ID` AS `USERID`,                      userdb.`USERNAME`,                      userdb.`PASSWORD`,                      userdb.`EMAIL`,                      userdb.`FORNAME`,                      userdb.`SURENAME`,                      fluidinfo.`ID` AS `FLUIDID`,                      fluidinfo.`USERID`,                      fluidinfo.`FIELD`,                      fluidinfo.`WELL`,                      fluidinfo.`TEST`,                      fluidinfo.`SAMPLE`,                      fluidinfo.`TEXT`,                      fluidinfo.`HISTORY`,                      fluidinfo.`METHANE`,                      fluidinfo.`ETHANE`,                      fluidinfo.`PROPANE`,                      fluidinfo.`CO2`,                      fluidinfo.`H2S`,                      fluidinfo.`NITROGEN`,                      fluidinfo.`IBUTANE`,                      fluidinfo.`NBUTANE`,                      fluidinfo.`PENTANE`,                      fluidinfo.`NHEXANE`,                      fluidinfo.`CYCPENTANE`,                      fluidinfo.`CYCHEXANE`,                      fluidinfo.`NHEPTANE`,                      fluidinfo.`NOCTANE`,                      fluidinfo.`NNONANE`,                      fluidinfo.`NDECANE`,                      fluidinfo.`BENZENE`,                      fluidinfo.`TOLUENE`,                      fluidinfo.`MXYLENE`,                      fluidinfo.`PXYLENE`,                      fluidinfo.`OXYLENE`,                      fluidinfo.`WATER`,                      fluidinfo.`METHANOL`,                      fluidinfo.`MEG`,                      fluidinfo.`TEG`,                      fluidinfo.`DEG`,                      fluidinfo.`MDEA`,                      fluidinfo.`PIPERAZINE`,                      fluidinfo.`ACETICACID`,                      fluidinfo.`PROPIONICACID`,                      fluidinfo.`NAPLUS`,                      fluidinfo.`FEPLUS`,                      fluidinfo.`CAPLUS`,                      fluidinfo.`H3OPLUS`,                      fluidinfo.`OHMINUS`,                      fluidinfo.`CO3MINUS`,                      fluidinfo.`CLMINUS`,                      fluidinfo.`C6`,                      fluidinfo.`C6MOLARMASS`,                      fluidinfo.`C6DENSITY`,                      fluidinfo.`C7`,                      fluidinfo.`C7MOLARMASS`,                      fluidinfo.`C7DENSITY`,                      fluidinfo.`C8`,                      fluidinfo.`C8MOLARMASS`,                      fluidinfo.`C8DENSITY`,                      fluidinfo.`C9`,                      fluidinfo.`C9MOLARMASS`,                      fluidinfo.`C9DENSITY`,                      fluidinfo.`C10`,                      fluidinfo.`C10MOLARMASS`,                      fluidinfo.`C10DENSITY`,                      fluidinfo.`C11`,                      fluidinfo.`C11MOLARMASS`,                      fluidinfo.`C11DENSITY`,                      fluidinfo.`C12`,                      fluidinfo.`C12MOLARMASS`,                      fluidinfo.`C12DENSITY`,                      fluidinfo.`C13`,                      fluidinfo.`C13MOLARMASS`,                      fluidinfo.`C13DENSITY`,                      fluidinfo.`CPLUS`,                      fluidinfo.`CPLUSMOLARMASS`,                      fluidinfo.`CPLUSDENSITY`,                      literatureandarticlestable.`ID` AS `LITID`,                      literatureandarticlestable.`AUTHOR`,                      literatureandarticlestable.`NAME`,                      literatureandarticlestable.`JOURNAL`,                      literatureandarticlestable.`VOLUME`,                      literatureandarticlestable.`PAGES`,                      literatureandarticlestable.`YEAR`,                      literatureandarticlestable.`REFERENCEID`,                      litterature.`ARTICLEID`,                      litterature.`MAXPRESSURE`,                      litterature.`MINPRESSURE`,                      litterature.`MAXTEMPERATURE`,                      litterature.`MINTEMPERATURE`,                      fluidinfo.`SHARED`  FROM litterature, experimentaldatatype, userdb, fluidinfo, literatureandarticlestable WHERE fluidinfo.`ID` = ?           AND litterature.`EXPTYPEID` = experimentaldatatype.`ID`           AND litterature.`FLUID_ID` = fluidinfo.`ID`           AND fluidinfo.`USERID` = userdb.`ID`           AND litterature.`ARTICLEID` = literatureandarticlestable.`ID`");
    ...
    public String getSQLdata(String expType) {
        ...
        for (int i = 0; i < ((ThermoSessionBean) getBean("Thermo$ThermoSessionBean")).getThermoSystem().getCompNames().length - 1; i++) {
            compSQL += "fluidinfo." + ((ThermoSessionBean) getBean("Thermo$ThermoSessionBean")).getThermoSystem().getCompNames()[i] + ">1e-30  " + andor + " ";
        }
        ...
        try {
            ...
            getLitteratureRowSet2().setCommand("SELECT ALL litterature.ID,                      litterature.FLUID_ID,                       litterature.TYPE,                      litterature.NAME,                      litterature.TEXT,                      litterature.EXPTYPEID,                      experimentaldatatype.ID AS EXPID,                      experimentaldatatype.TYPE,                      userdb.ID AS USERID,                      userdb.USERNAME,                      userdb.PASSWORD,                      userdb.EMAIL,                      userdb.FORNAME,                      userdb.SURENAME,                      fluidinfo.ID AS FLUIDID,                      fluidinfo.USERID,                      fluidinfo.FIELD,                      fluidinfo.WELL,                      fluidinfo.TEST,                      fluidinfo.SAMPLE,                      fluidinfo.TEXT,                      fluidinfo.HISTORY,                      fluidinfo.METHANE,                      fluidinfo.ETHANE,                      fluidinfo.PROPANE,                      fluidinfo.CO2,                      fluidinfo.H2S,                      fluidinfo.NITROGEN,                      fluidinfo.IBUTANE,                      fluidinfo.NBUTANE,                      fluidinfo.PENTANE,                      fluidinfo.NHEXANE,                      fluidinfo.CYCPENTANE,                      fluidinfo.CYCHEXANE,                      fluidinfo.NHEPTANE,                      fluidinfo.NOCTANE,                      fluidinfo.NNONANE,                      fluidinfo.NDECANE,                      fluidinfo.BENZENE,                      fluidinfo.TOLUENE,                      fluidinfo.MXYLENE,                      fluidinfo.PXYLENE,                      fluidinfo.OXYLENE,                      fluidinfo.WATER,                      fluidinfo.METHANOL,                      fluidinfo.MEG,                      fluidinfo.TEG,                      fluidinfo.DEG,                      fluidinfo.MDEA,                      fluidinfo.PIPERAZINE,                      fluidinfo.ACETICACID,                      fluidinfo.PROPIONICACID,                      fluidinfo.NAPLUS,                      fluidinfo.FEPLUS,                      fluidinfo.CAPLUS,                      fluidinfo.H3OPLUS,                      fluidinfo.OHMINUS,                      fluidinfo.CO3MINUS,                      fluidinfo.CLMINUS,                      fluidinfo.C6,                      fluidinfo.C6MOLARMASS,                      fluidinfo.C6DENSITY,                      fluidinfo.C7,                      fluidinfo.C7MOLARMASS,                      fluidinfo.C7DENSITY,                      fluidinfo.C8,                      fluidinfo.C8MOLARMASS,                      fluidinfo.C8DENSITY,                      fluidinfo.C9,                      fluidinfo.C9MOLARMASS,                      fluidinfo.C9DENSITY,                      fluidinfo.C10,                      fluidinfo.C10MOLARMASS,                      fluidinfo.C10DENSITY,                      fluidinfo.C11,                      fluidinfo.C11MOLARMASS,                      fluidinfo.C11DENSITY,                      fluidinfo.C12,                      fluidinfo.C12MOLARMASS,                      fluidinfo.C12DENSITY,                      fluidinfo.C13,                      fluidinfo.C13MOLARMASS,                      fluidinfo.C13DENSITY,                      fluidinfo.CPLUS,                      fluidinfo.CPLUSMOLARMASS,                      fluidinfo.CPLUSDENSITY,                      literatureandarticlestable.ID AS LITID,                      literatureandarticlestable.AUTHOR,                      literatureandarticlestable.NAME AS LITNAME,                      literatureandarticlestable.JOURNAL,                      literatureandarticlestable.VOLUME,                      literatureandarticlestable.PAGES,                      literatureandarticlestable.YEAR,                      literatureandarticlestable.REFERENCEID,                      litterature.ARTICLEID,                      litterature.MAXPRESSURE,                      litterature.MINPRESSURE,                      litterature.MAXTEMPERATURE,                      litterature.MINTEMPERATURE,                      fluidinfo.SHARED  FROM litterature, experimentaldatatype, userdb, fluidinfo, literatureandarticlestable WHERE litterature.EXPTYPEID = experimentaldatatype.ID           AND litterature.FLUID_ID = fluidinfo.ID           AND fluidinfo.USERID = userdb.ID   AND litterature.ARTICLEID = literatureandarticlestable.ID " +
                    temp1 + compSQL +
                  //  "GROUP BY litterature.ID, litterature.FLUID_ID, litterature.FILE, litterature.NAME, litterature.TEXT, litterature.EXPTYPEID, litterature.TYPE, experimentaldatatype.ID, experimentaldatatype.TYPE, userdb.ID, userdb.USERNAME, userdb.PASSWORD, userdb.EMAIL, userdb.FORNAME, userdb.SURENAME, fluidinfo.ID, fluidinfo.USERID, fluidinfo.FIELD, fluidinfo.WELL, fluidinfo.TEST, fluidinfo.SAMPLE, fluidinfo.TEXT, fluidinfo.HISTORY, fluidinfo.METHANE, fluidinfo.ETHANE, fluidinfo.PROPANE, fluidinfo.CO2, fluidinfo.H2S, fluidinfo.NITROGEN, fluidinfo.IBUTANE, fluidinfo.NBUTANE, fluidinfo.PENTANE, fluidinfo.NHEXANE, fluidinfo.CYCPENTANE, fluidinfo.CYCHEXANE, fluidinfo.NHEPTANE, fluidinfo.NOCTANE, fluidinfo.NNONANE, fluidinfo.NDECANE, fluidinfo.BENZENE, fluidinfo.TOLUENE, fluidinfo.MXYLENE, fluidinfo.PXYLENE, fluidinfo.OXYLENE, fluidinfo.WATER, fluidinfo.METHANOL, fluidinfo.MEG, fluidinfo.TEG, fluidinfo.DEG, fluidinfo.MDEA, fluidinfo.PIPERAZINE, fluidinfo.ACETICACID, fluidinfo.PROPIONICACID, fluidinfo.NAPLUS, fluidinfo.FEPLUS, fluidinfo.CAPLUS, fluidinfo.H3OPLUS, fluidinfo.OHMINUS, fluidinfo.CO3MINUS, fluidinfo.CLMINUS, fluidinfo.C6, fluidinfo.C6MOLARMASS, fluidinfo.C6DENSITY, fluidinfo.C7, fluidinfo.C7MOLARMASS, fluidinfo.C7DENSITY, fluidinfo.C8, fluidinfo.C8MOLARMASS, fluidinfo.C8DENSITY, fluidinfo.C9, fluidinfo.C9MOLARMASS, fluidinfo.C9DENSITY, fluidinfo.C10, fluidinfo.C10MOLARMASS, fluidinfo.C10DENSITY, fluidinfo.C11, fluidinfo.C11MOLARMASS, fluidinfo.C11DENSITY, fluidinfo.C12, fluidinfo.C12MOLARMASS, fluidinfo.C12DENSITY, fluidinfo.C13, fluidinfo.C13MOLARMASS, fluidinfo.C13DENSITY, fluidinfo.CPLUS, fluidinfo.CPLUSMOLARMASS, fluidinfo.CPLUSDENSITY, litterature.FLUID_ID, litterature.MAXPRESSURE, litterature.MINPRESSURE, litterature.MAXTEMPERATURE, litterature.MINTEMPERATURE, litterature.ARTICLEID");
    ...
    public int getCountSQLdata(String expType) {
        ...
        try {
         ...
         //   getLitteratureRowSet2().setCommand("SELECT COUNT(litterature.ID) FROM litterature, experimentaldatatype, userdb, fluidinfo, literatureandarticlestable WHERE litterature.EXPTYPEID = experimentaldatatype.ID           AND litterature.FLUID_ID = fluidinfo.ID           AND fluidinfo.USERID = userdb.ID   AND litterature.ARTICLEID = literatureandarticlestable.ID " +
         //           temp1 + compSQL);
