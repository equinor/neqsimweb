...
public class SessionBean1 extends AbstractSessionBean {
    ...
    private void _init() throws Exception {
        pipelineParameterRowSet.setDataSourceName("java:comp/env/jdbc/neqsimdatabase_MySQL");
        ...
        lngShipRowSet.setDataSourceName("java:comp/env/jdbc/neqsimdatabase_MySQL");
        ...
        speccountryRowSet.setDataSourceName("java:comp/env/jdbc/neqsimdatabase_MySQL");
        ...
        entrypointsRowSet.setDataSourceName("java:comp/env/jdbc/neqsimdatabase_MySQL");
        ...
        analyserlocationviewRowSet.setDataSourceName("java:comp/env/jdbc/neqsimdatabase_MySQL");
        ...
        LNGageingRowSet.setDataSourceName("java:comp/env/jdbc/neqsimdatabase_MySQL");
        ...
        fieldDBRowSet.setDataSourceName("java:comp/env/jdbc/neqsimdatabase_MySQL");
        ...
        pipePlantDBRowSet.setDataSourceName("java:comp/env/jdbc/neqsimdatabase_MySQL");
        ...
        pipePlantSumDBRowSet.setDataSourceName("java:comp/env/jdbc/neqsimdatabase_MySQL");
        ...
        pipeDBRowSet.setDataSourceName("java:comp/env/jdbc/neqsimdatabase_MySQL");
        ...
        fieldproductionDBRowSet.setDataSourceName("java:comp/env/jdbc/neqsimdatabase_MySQL");
        ...
        fieldDBNameRowSet.setDataSourceName("java:comp/env/jdbc/neqsimdatabase_MySQL");
        fieldDBNameRowSet.setCommand("SELECT ALL fielddb.`NAME`, fielddb.`ID`  FROM fielddb");
        fieldDBNameRowSet.setTableName("fieldDBRowSet");

        fieldDBRowSet2.setDataSourceName("java:comp/env/jdbc/neqsimdatabase_MySQL");
        ...
        analysertypeviewRowSet.setDataSourceName("java:comp/env/jdbc/neqsimdatabase_MySQL");
        ...
        analysersRowSet.setDataSourceName("java:comp/env/jdbc/neqsimdatabase_MySQL");
        ...
        fluidinfoRowSet.setDataSourceName("java:comp/env/jdbc/neqsimdatabase_MySQL");
        ...
        fluidinfoRowSetAddComp.setDataSourceName("java:comp/env/jdbc/neqsimdatabase_MySQL");
        ...
        fluidinfoFullTableRowSet.setDataSourceName("java:comp/env/jdbc/neqsimdatabase_MySQL");
        ...
        userdbRowSet.setDataSourceName("java:comp/env/jdbc/neqsimdatabase_MySQL");
        ...
        litteratureRowSet.setDataSourceName("java:comp/env/jdbc/neqsimdatabase_MySQL");
        ...
        litteratureRowSetGetLitID.setDataSourceName("java:comp/env/jdbc/neqsimdatabase_MySQL");
        ...
        experimentaldatatypeRowSet.setDataSourceName("java:comp/env/jdbc/neqsimdatabase_MySQL");
        ...
        litteratureRowSetTable.setDataSourceName("java:comp/env/jdbc/neqsimdatabase_MySQL");
        ...
        co2mdeaRowSet.setDataSourceName("java:comp/env/jdbc/neqsimdatabase_MySQL");
        co2mdeaRowSet.setCommand("SELECT * FROM co2mdea");
        co2mdeaRowSet.setTableName("co2mdea");
        webcomponentsRowSet.setDataSourceName("java:comp/env/jdbc/neqsimdatabase_MySQL");
        ...
        litteratureRowSetDataBase.setDataSourceName("java:comp/env/jdbc/neqsimdatabase_MySQL");
        ...
        literatureandarticlestableRowSet.setDataSourceName("java:comp/env/jdbc/neqsimdatabase_MySQL");
        ...
        literatureandarticlestableRowSetSetArtID.setDataSourceName("java:comp/env/jdbc/neqsimdatabase_MySQL");
        ...
        literatureandarticlestableRowSetDelete.setDataSourceName("java:comp/env/jdbc/neqsimdatabase_MySQL");
        ...
        documentsRowSet.setDataSourceName("java:comp/env/jdbc/neqsimdatabase_MySQL");
        ...
        standardsRowSet.setDataSourceName("java:comp/env/jdbc/neqsimdatabase_MySQL");
        ...
        standardsFullRowSet.setDataSourceName("java:comp/env/jdbc/neqsimdatabase_MySQL");
        ...
        documentsRowSetWithInfo.setDataSourceName("java:comp/env/jdbc/neqsimdatabase_MySQL");
        ...
        documenttypeRowSet.setDataSourceName("java:comp/env/jdbc/neqsimdatabase_MySQL");
        ...
        analysertypesviewRowSet.setDataSourceName("java:comp/env/jdbc/neqsimdatabase_MySQL");
        ...
        analyserlocationsRowSet.setDataSourceName("java:comp/env/jdbc/neqsimdatabase_MySQL");
        ...
        analysertypesRowSet.setDataSourceName("java:comp/env/jdbc/neqsimdatabase_MySQL");
        analysertypesRowSet.setCommand("SELECT ALL analysertypes.`ID1`, \n                    analysertypes.`INSTTYPES` \nFROM analysertypes");
        analysertypesRowSet.setTableName("analysertypes");
        addAnalysersRowSet.setDataSourceName("java:comp/env/jdbc/neqsimdatabase_MySQL");
        ...
        fluidinfoFullTableRowSet2.setDataSourceName("java:comp/env/jdbc/neqsimdatabase_MySQL");
        ...
        litteratureRowSet2.setDataSourceName("java:comp/env/jdbc/neqsimdatabase_MySQL");
        litteratureRowSet2.setCommand("SELECT ALL litterature.`ID`, \n                    litterature.`FLUID_ID`, \n                    litterature.`FILE`, \n                    litterature.`TYPE`, \n                    litterature.`NAME`, \n                    litterature.`TEXT`, \n                    litterature.`EXPTYPEID`, \n                    experimentaldatatype.`ID` AS `EXPID`, \n                    experimentaldatatype.`TYPE` AS `EXPTYPE`, \n                    userdb.`ID` AS `USERID`, \n                    userdb.`USERNAME`, \n                    userdb.`PASSWORD`, \n                    userdb.`EMAIL`, \n                    userdb.`FORNAME`, \n                    userdb.`SURENAME`, \n                    fluidinfo.`ID` AS `FLUIDID`, \n                    fluidinfo.`USERID`, \n                    fluidinfo.`FIELD`, \n                    fluidinfo.`WELL`, \n                    fluidinfo.`TEST`, \n                    fluidinfo.`SAMPLE`, \n                    fluidinfo.`TEXT`, \n                    fluidinfo.`HISTORY`, \n                    fluidinfo.`METHANE`, \n                    fluidinfo.`ETHANE`, \n                    fluidinfo.`PROPANE`, \n                    fluidinfo.`CO2`, \n                    fluidinfo.`H2S`, \n                    fluidinfo.`NITROGEN`, \n                    fluidinfo.`IBUTANE`, \n                    fluidinfo.`NBUTANE`, \n                    fluidinfo.`PENTANE`, \n                    fluidinfo.`NHEXANE`, \n                    fluidinfo.`CYCPENTANE`, \n                    fluidinfo.`CYCHEXANE`, \n                    fluidinfo.`NHEPTANE`, \n                    fluidinfo.`NOCTANE`, \n                    fluidinfo.`NNONANE`, \n                    fluidinfo.`NDECANE`, \n                    fluidinfo.`BENZENE`, \n                    fluidinfo.`TOLUENE`, \n                    fluidinfo.`MXYLENE`, \n                    fluidinfo.`PXYLENE`, \n                    fluidinfo.`OXYLENE`, \n                    fluidinfo.`WATER`, \n                    fluidinfo.`METHANOL`, \n                    fluidinfo.`MEG`, \n                    fluidinfo.`TEG`, \n                    fluidinfo.`DEG`, \n                    fluidinfo.`MDEA`, \n                    fluidinfo.`PIPERAZINE`, \n                    fluidinfo.`ACETICACID`, \n                    fluidinfo.`PROPIONICACID`, \n                    fluidinfo.`NAPLUS`, \n                    fluidinfo.`FEPLUS`, \n                    fluidinfo.`CAPLUS`, \n                    fluidinfo.`H3OPLUS`, \n                    fluidinfo.`OHMINUS`, \n                    fluidinfo.`CO3MINUS`, \n                    fluidinfo.`CLMINUS`, \n                    fluidinfo.`C6`, \n                    fluidinfo.`C6MOLARMASS`, \n                    fluidinfo.`C6DENSITY`, \n                    fluidinfo.`C7`, \n                    fluidinfo.`C7MOLARMASS`, \n                    fluidinfo.`C7DENSITY`, \n                    fluidinfo.`C8`, \n                    fluidinfo.`C8MOLARMASS`, \n                    fluidinfo.`C8DENSITY`, \n                    fluidinfo.`C9`, \n                    fluidinfo.`C9MOLARMASS`, \n                    fluidinfo.`C9DENSITY`, \n                    fluidinfo.`C10`, \n                    fluidinfo.`C10MOLARMASS`, \n                    fluidinfo.`C10DENSITY`, \n                    fluidinfo.`C11`, \n                    fluidinfo.`C11MOLARMASS`, \n                    fluidinfo.`C11DENSITY`, \n                    fluidinfo.`C12`, \n                    fluidinfo.`C12MOLARMASS`, \n                    fluidinfo.`C12DENSITY`, \n                    fluidinfo.`C13`, \n                    fluidinfo.`C13MOLARMASS`, \n                    fluidinfo.`C13DENSITY`, \n                    fluidinfo.`CPLUS`, \n                    fluidinfo.`CPLUSMOLARMASS`, \n                    fluidinfo.`CPLUSDENSITY`, \n                    literatureandarticlestable.`ID` AS `LITID`, \n                    literatureandarticlestable.`AUTHOR`, \n                    literatureandarticlestable.`NAME`, \n                    literatureandarticlestable.`JOURNAL`, \n                    literatureandarticlestable.`VOLUME`, \n                    literatureandarticlestable.`PAGES`, \n                    literatureandarticlestable.`YEAR`, \n                    literatureandarticlestable.`REFERENCEID`, \n                    litterature.`ARTICLEID`, \n                    litterature.`MAXPRESSURE`, \n                    litterature.`MINPRESSURE`, \n                    litterature.`MAXTEMPERATURE`, \n                    litterature.`MINTEMPERATURE`, \n                    fluidinfo.`SHARED` \nFROM litterature, experimentaldatatype, userdb, fluidinfo, literatureandarticlestable\nWHERE fluidinfo.`ID` = ?\n          AND litterature.`EXPTYPEID` = experimentaldatatype.`ID`\n          AND litterature.`FLUID_ID` = fluidinfo.`ID`\n          AND fluidinfo.`USERID` = userdb.`ID`\n          AND litterature.`ARTICLEID` = literatureandarticlestable.`ID`");
        litteratureRowSet2.setTableName("litterature");
        pipelineparametersRowSet.setDataSourceName("java:comp/env/jdbc/neqsimdatabase_MySQL");
        ...
        fluidinfoRowSet1.setDataSourceName("java:comp/env/jdbc/neqsimdatabase_MySQL");
        fluidinfoRowSet1.setCommand("SELECT * FROM fluidinfo");
        fluidinfoRowSet1.setTableName("fluidinfo");
        pvt_satptRowSet.setDataSourceName("java:comp/env/jdbc/neqsimdatabase_MySQL");
        ...
        companyRowSet.setDataSourceName("java:comp/env/jdbc/neqsimdatabase_MySQL");
        ...
        analysersRowSet1.setDataSourceName("java:comp/env/jdbc/neqsimdatabase_MySQL");
        analysersRowSet1.setCommand("SELECT * FROM analysers");
        analysersRowSet1.setTableName("analysers");
        userdbRowSet1.setDataSourceName("java:comp/env/jdbc/neqsimdatabase_MySQL");
        userdbRowSet1.setCommand("SELECT * FROM userdb");
        userdbRowSet1.setTableName("userdb");
        analyserlocationsRowSet1.setDataSourceName("java:comp/env/jdbc/neqsimdatabase_MySQL");
